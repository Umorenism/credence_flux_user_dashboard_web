...
export default function Header({ toggleSidebar }) {
  ...
  useEffect(() => {
    loadProfile();
    // Refresh every 90 seconds (less aggressive than sidebar)
  ...
  // Quick dashboard search (same as before)
  const dashboardPages = [
    { name: "Dashboard", path: "/home", keywords: ["home", "dashboard"] },
    ...
    >
      <div className="flex items-center justify-between px-4 md:px-6 py-3 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-3 md:gap-5">
          ...
          {/* Mobile menu toggle */}
          <motion.button
            className={`md:hidden p-2.5 rounded-lg transition border
              ${isDark ? "border-gray-700 hover:bg-gray-800 text-orange-400" : "border-gray-300 hover:bg-gray-200 text-orange-600"}`}
            onClick={toggleSidebar}
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          >
