...
// //       >
// //         {/* Logo / Brand */}
// //         <div className="p-2  border-b border-gray-200 dark:border-gray-800 flex  justify-start">
// //           {/* <img
// //             src={logo}
// //             alt="CredenceFlux Logo"
// //             className="h-[100px] md:h-[300px] mt-20 w-[200px] lg:h-24 w-auto object-cover drop-shadow-lg"
// //           /> */}
// //           <div className="h-20 w-full mt-20 md:mt-0 sm:mt-0 lg:mt-10 bg-white dark:bg-gray-900 rounded-lg flex items-center  text-2xl font-bold text-orange-500 drop-shadow-md">
// //            <img
// //             src={logo}
// //             alt="CredenceFlux Logo"
// //             className="h-auto md:h-[350px] lg:h-[400px] w-auto object-contain drop-shadow-lg"
// //           /> 
// //           </div>
// //         </div>
...
//   <div className="h-20 md:h-28 lg:h-32 w-full flex items-center justify-start overflow-hidden">
//     <img
//       src={logo}
//       alt="CredenceFlux Logo"
//       className="h-full md:h-20 lg:h-24 w-auto max-w-full object-contain drop-shadow-lg cursor-pointer"
...
//                 closeSidebar();
//               }}
//               className="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-orange-50 dark:hover:bg-gray-800/70 hover:text-orange-600 dark:hover:text-orange-400 transition-colors duration-200 font-medium"
//             >
//               <item.icon className="w-5 h-5 flex-shrink-0" />
//               <span>{item.label}</span>
//             </Link>
